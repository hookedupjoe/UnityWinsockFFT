...
namespace HookedupLED
{
    ...
    public class HookedupLEDAPI : MonoBehaviour
    {
        ...
        public async Task<WebReply> RunWebCommand(String theURLBase, String theURI)
        {
        ...
        public void StartConnection(String theURL)
        {
            this.WebSocketClient = new WsClient(theURL);        
            WSInst = this.WebSocketClient.Connect();
        }
        public void EndConnection()
        {
            //ToDo:  End Connection
            Debug.Log("EndConnection not implemented");
        }
